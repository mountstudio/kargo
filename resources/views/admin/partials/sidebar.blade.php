<div class="list-group">
    ...
    <a href="{{ route('admin.box.index') }}" class="list-group-item list-group-item-action {{ request()->is('admin/box*') ? 'active' : '' }}">{{ __('Boxes') }}</a>
    <a href="{{ route('admin.city.index') }}" class="list-group-item list-group-item-action {{ request()->is('admin/city*') ? 'active' : '' }}">{{ __('Cities') }}</a>
    <a href="{{ route('admin.package.index') }}" class="list-group-item list-group-item-action {{ request()->is('admin/package*') ? 'active' : '' }}">{{ __('Packages') }}</a>
    <a href="{{ route('admin.packed.index') }}" class="list-group-item list-group-item-action {{ request()->is('admin/packed*') ? 'active' : '' }}">{{ __('Packeds') }}</a>
